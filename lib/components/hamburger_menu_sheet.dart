...
class HamburgerMenuSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // ✅ Goal:
    // - Big screens: everything fits, no scrolling.
    // - Small screens: becomes scrollable so nothing gets cut.
    return ClipRRect(
          ...
          child: SafeArea(
            child: LayoutBuilder(
              builder: (context, constraints) {
                // We use a scroll view always, but when content fits,
                // it won't feel scrollable (no overflow / no cut).
                return SingleChildScrollView(
                  ...
                  child: ConstrainedBox(
                    constraints: BoxConstraints(
                      // makes Spacer work and keeps layout full height on big screens
