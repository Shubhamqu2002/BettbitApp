...
import '../../services/password/change_login_password_service.dart';

class ChangeLoginPasswordModal extends StatefulWidget {
  const ChangeLoginPasswordModal({super.key});

  @override
  State<ChangeLoginPasswordModal> createState() =>
      _ChangeLoginPasswordModalState();
}

class _ChangeLoginPasswordModalState extends State<ChangeLoginPasswordModal> {
  ...
  // Same palette as your previous design
  ...
  final ChangeLoginPasswordService _service = ChangeLoginPasswordService();
  ...
  Future<void> _submit() async {
    ...
    try {
      await _service.changeLoginPassword(newPasswordPlain: newPass);

      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: const Text('✅ Login password changed successfully'),
  ...
  Widget build(BuildContext context) {
    ...
    // Make sure modal never exceeds screen height (prevents overflow)
    final maxSheetHeight = math.min(screenH * 0.92, 680.0);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                /// ✅ Scroll-safe body (prevents overflow perfectly)
                Flexible(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _rule('At least one digit', hasDigit),
                ...
                /// Button (stays visible, no overflow)
                Material(
                  color: Colors.transparent,
                  child: InkWell(
